    ...
    <div sx={styles.card} className={data.is_recommended ? 'recommended' : ''}>
      ...
      >
        ...
        <span sx={styles.amount}>
          ${data.amount}/<small>per tester</small>
        </span>
        <Box as="ul" variant="styles.unStyled" sx={styles.features}>
          ...
          <li>
            <span>In House Tester</span>
            <FeatureIcon value={data.inhouse_tester} />
          </li>
          <li>
          ...
          <li>
            <span>Multiple Device Testing</span>
            <FeatureIcon value={data.multiple_device} />
          </li>
          <li>
