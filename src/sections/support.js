...
const data = [
  {
    ...
    text: `Email us detailed information of the problem you are facing and we will look into it right away`,
  },
  {
    id: 2,
    icon: icon2,
    title: 'Live ticket support',
    text: `Need to know more or got stuck somewhere in middle, Raise a ticket and get a solution within minutes`,
  },
];
          ...
          <div sx={styles.content}>
            <div sx={styles.heading}>
              <Heading sx={styles.title}>
                Do you need help? Our support team is ready to help you 24x7*
              </Heading>
