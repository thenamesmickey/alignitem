      ...
      <Container>
        <Box sx={styles.contentWrapper}>
          <Box sx={styles.bannerContent}>
            <Heading as="h1">
              Great company is built with smooth user experience.
            </Heading>
            <Text as="p">
              Get your products tested here live by the niche audience before diving deep into the ocean.
              Know what people are liking and where we are lacking as mantra to sucess comes from our audience.
            </Text>
