        ...
        <Box sx={styles.grid}>
          ...
          <Box sx={styles.content}>
            <Heading sx={styles.title}>
              Customer analysis is our main priority with your hundred percent satisfaction.
            </Heading>
            <Text as="p" sx={styles.summary}>
              Our audience experience what world is going to feel and give rating to make it smooth. So that world can adapt with ease.
              Our audience rate on the basis of :
            </Text>
